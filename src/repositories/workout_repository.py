...
class WorkoutRepository:
    ...
    async def update(self, id: UUID, user_id: UUID, in_data: dict) -> Workout | None:
    ...
    async def add_exercise(
        self, workout_id: UUID, user_id: UUID, in_data: dict
    ...
    async def update_exercise(
        self, exercise_id: UUID, workout_id: UUID, user_id: UUID, in_data: dict
    ) -> WorkoutExercise | None:
        workout = await self.get_by_id(workout_id)
        if not workout or workout.user_id != user_id:
            return None
